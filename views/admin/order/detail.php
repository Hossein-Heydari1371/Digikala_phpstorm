                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                foreach ($basketItems as $item) {
                                    ?>
                                    <tr>
                                        <td><img src="public/images/product/<?= $item['id'] ?>/product_115.jpg"
                                                 alt="" width="80"></td>
                                        <td><?= $item['title'] ?></td>
                                        <td><?= $item['number'] ?></td>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>آدرس</td>
                                        <td> <?= $address['address'] ?> <?= $address['vahed'] ?><?= $address['pelak'] ?> </td>
                                    </tr>
                                    <tr>
                                        <td>تاریخ سفارش</td>
                                    ...
                                    <tr style="background: #f62d51;color: #fff">
                                        <td>مبلغ تخفیف</td>
                                        <td> <?= number_format($order[0]['discount']) ?>  </td>
                                    </tr>
                                    <tr>
                                        <td>کدتخفیف تخفیف</td>
                                    ...
                                    <tr style="background: #000000;color: #fff;">
                                        <td>مبلغ کل سفارش</td>
                                        <td style="font-size: 18px;font-weight: 900"> <?= number_format($order[0]['price']) ?>
                                            تومان
                                        </td>
                                    </tr>
