            ...
            <div class="col-12">
                <div class="box">
                    ...
                    <form class="form" action="adminReports/index" method="post">
                        <div class="box-body">
                            <h4 class="box-title text-info"><i class="ti-user mr-15"></i> سفارشات از

                                <?php

                                if (isset($reports)) {
                                    ?>
                                    تاریخ (   <?= $startDate ?> <span style="color: #000">الی</span> <?= $endDate ?>)
                                    <?php
                                }
                                ?>
                            ...
                            <div class="">
                                <div class="callout callout-success font-size-15">
                                    فروش کل <?= number_format($totalPrice) ?>
                                </div>
                                <div class="callout callout-danger font-size-15">
