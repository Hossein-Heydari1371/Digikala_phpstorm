...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="page-title">مدیریت کارابران </h3>
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active" aria-current="page"> تعداد
                                کاربران <?= sizeof($users) ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="table-responsive">
                            <table id="productorder" class="table table-hover no-wrap product-order"
                                ...
                                <tr>
                                    ...
                                    <td> <?= $row['mobile'] ?> </td>
                                    <td> <?= $row['email'] ?> </td>
                                    <td><a class="btn btn-primary" href="adminUsers/userOrders/<?= $row['id'] ?>">
                                            سفارشات
                                        </a></td>

                                    <td><select class="input-group selectpicker"
