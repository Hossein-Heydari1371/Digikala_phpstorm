    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                ...
                <a href="adminProduct/addReview/<?= $productInfo['id'] ?>" style="color: #fff"
                   class="btn btn-success mb-5">افزودن</a>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table id="productorder" class="table table-hover no-wrap product-order"
                                    ...
                                    <tr class="bg-secondary">
                                        <th>ردیف</th>
                                        <th width="50%">عنوان نقد و بررسی</th>
                                    ...
                                    foreach ($review as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['title'] ?></td>
                                            <td>
                                                <a href="adminProduct/addReview/<?= $productInfo['id'] ?>/<?= $row['id'] ?>"
                                                   class="btn btn-yellow mb-5" target="_blank">ویرایش</a></td>
                                            <td><a type="button" class="btn btn-danger mb-5 sa-params"  data-id="<?= $row['id'] ?>"
                                                >حذف</a></td>
                                        </tr>
