                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="Product Name" value="<?= @$productInfo['title'] ?>">
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input name="price" type="text" class="form-control"
                                                           placeholder="270" value="<?= @$productInfo['price'] ?>"></div>
                                            </div>
                                        </div>
                                        <!--/span-->
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="product-img text-left">
                                                <img src="public/images/product/<?=$productInfo['id']?>/product_600.jpg" alt="">
