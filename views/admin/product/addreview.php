            ...
            <div class="d-flex align-items-center">
                <div class="mr-auto">
                    ...
                    if ($edit == 1) {
                        ...
                        ?>
                        <h3 class="page-title">اضافه کردن نقد و بررسی</h3>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="box">
                        ...
                        <div class="box-body">
                            <form action="adminProduct/addReview/<?= $productInfo['id'] ?>/<?= @$review['id'] ?>" class="form-element"
                                  method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="text-info">عنوان نقد</label>
                                                <input name="title" type="text" class="form-control"
                                                       placeholder="Product Name" value="<?= @$review['title'] ?>">
                                            </div>
                                        </div>
