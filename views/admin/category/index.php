        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                ...
                <a style="color: #fff" type="button" class="btn btn-success mb-5" data-toggle="modal"
                   data-target="#myModal" onclick="removeCategoryId()">افزودن</a>
            </div>
        </div>
                            ...
                            <div class="table-responsive">
                                <table id="productorder" class="table table-hover no-wrap product-order"
                                    ...
                                    <tr class="bg-secondary">
                                        ...
                                        <th width="20%">ویژگی ها</th>
                                        <th width="20%">انتخاب</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="adminCategory/index/<?= $row['id'] ?>"
                                                   ...
                                                   data-toggle="tooltip" data-original-title="مشاهده زیردسته ها">
                                                    <i class="ti-eye"></i>
                                                </a>
                                            ...
                                            <td><a href="adminCategory/attributes/<?=$row['id']?>"
                                                   class="btn btn-secondary mb-5" target="_blank">ویژگی ها</a></td>
                                            <td>
                                                <div class="checkbox">
