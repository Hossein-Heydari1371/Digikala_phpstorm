        ...
        <div class="content-header">
            <div class="d-flex align-items-center">
                    ...
                    <div class="d-inline-block align-items-center">
                        <nav>
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"> ویژگی
                                    (<?= @$attributeInfo['title'] ?> )
                                </li>
                            </ol>
                        </nav>
                ...
                <a style="color: #fff" type="button" class="btn btn-success mb-5" data-toggle="modal"
                   data-target="#myModal" onclick="removeAttributesId()">افزودن</a>
            </div>
        </div>
                                ...
                                <table id="productorder" class="table table-hover no-wrap product-order"
                                    ...
                                    foreach ($attributes as $row) {
                                        ...
                                        <tr>
                                            <td><?= $row['id'] ?></td>
                                            <td><?= $row['title'] ?></td>
                                            <td> <a onclick="editAttribute(<?= $row['id'] ?>,'<?= $row['title'] ?>')"
                                            ...
                                            if (!isset($attributeInfo['id'])) {
                                                ...
                                                <td>
                                                    <a href="adminCategory/attributes/<?= $row['category_id'] ?>/<?= $row['id'] ?>"
                                                       class="btn btn-secondary mb-5">زیر ویژگی ها</a></td>

                                                <?php
                                            }
                                            ?>
                                            <td><a   class="btn btn-danger mb-5 sa-params"
                                                   data-id="<?= $row['id'] ?>" target="_blank">حذف</a></td>
                                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="adminCategory/attributes/<?= $categoryInfo['id'] ?>/<?= @$attributeInfo['id'] ?>" method="post"
