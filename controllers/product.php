...
class product extends Controller
{
    ...
    function tabs($id, $category_id)
    {
        ...
        if ($number == 2) {
            ...
            $data = ['comment_param_new' => $comment_param_new, 'comments' => $comments,
                'scores_total' => $scores_total, 'comments_number' => $comments_number
            ];
    ...
    function addToBasket($product_id)
    {
        ...
        $this->model->addToBasket($product_id, $_POST);
    }
